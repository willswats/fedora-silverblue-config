...
1. [gnome-settings](./setup/system/gnome-settings.md)
2. [gnome-tweaks](./setup/system/gnome-tweaks.md)
3. [gnome-terminal](./setup/system/gnome-terminal.md)
4. [gnome-disks](./setup/system/gnome-disks.md)
5. [folder-structure](./setup/system/folder-structure.md)
...
8. [firefox](./setup/applications/firefox.md)
9. [steam](./setup/applications/steam.md)
